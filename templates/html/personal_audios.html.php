    ...
    <div class="container-audio-personal">
      ...
      <!-- Player bar -->
        <div class="player-bar">
          ...
          <h1 class="fcc-title">Effet Composé</h1>
        ...
        <div class="player-content">
          ...
          <!-- Image of song played -->
          <div id="player-album-art">
            <img
              src="../../templates/images/compound_effect.jpg"
              alt="song cover art"
              class="audio-personal-logo"
            />
